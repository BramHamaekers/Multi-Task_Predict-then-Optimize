...
def trainSeparated(dataloader, dataloader_val, optmodels, data_params, train_params):
    ...
    for ind, (task, optmodel) in enumerate(optmodels.items()):
        ...
        # init FY loss
        pfyl = pyepo.func.perturbedFenchelYoung(optmodel, n_samples=5, processes=proc)
        # set stopper
...
def our_trainSeparated(dataloader, dataloader_val, optmodels, data_params, train_params):
    """
    Train with separated model
    """
    m = data_params["item"] # number of nodes
...
def our_trainComb(dataloader, dataloader_val, optmodels, data_params, train_params):
    """
    Train with simple combination
    """
    m = data_params["item"] # number of nodes
...
def our_trainGradNorm(dataloader, dataloader_val, optmodels, data_params, train_params):
    """
    Train with GradNorm
    """
    m = data_params["item"] # number of nodes
